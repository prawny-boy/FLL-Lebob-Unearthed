...
class LebobDriveBase(DriveBase):
    ...
    def _wait_until_stalled(self, speed_tolerance: int = 0, turn_tolerance: int = 0, then=Stop.COAST):
    ...
    def straight_until_stalled(self, speed: int, tolerance: int = 0, then=Stop.COAST):
    ...
    def turn_until_stalled(self, turn_rate: int = None, tolerance: int = 0, then=Stop.COAST):
...
def mission_6():
    ...
    db.straight(80)
    db.arc(
        120.74476231356391916348639285701748365912793783065083274823641938508136497356380461034953749264,
        156.375317539642659565047405374562623472351065014508364581934759138465198327498126591283479182364012350123478,
    ...
    db.settings(400)
    db.turn(-95.9929382839109929128830329329329424374384394399539853943094293293293932)
